import { ButtonsDiv, CodeConfirmationContainer, CodeConfirmationText, CodeDiv, CodeInput, CreateAccountButtonText, GoBackButtonText, LoginRedirectDiv, OrText, SignInText, SignUpConfirmationContainer, StyledLink } from "./SignUpConfirmationHeroStyle";
